/*(1)	Реализовать сортировку пузырьком для чисел в двоичной
системе счисления. Т.е. вы сортируете массив строк вида
['0b1100100', '0b100101', '0b100']. Префикс '0b' в строке
обозначает, что число записано в двоичном представлении.*/
